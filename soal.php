                        ...
                        <div class='col-md-12'>
                            ...
                            if ($soal['file'] <> '') {
                                ...
                                if (in_array($ext, $image)) {
                                    echo "<span  id='zoom' style='display:inline-block'> <img  src='$url_sianida/$soal[file]' class='img-responsive'/></span>";
                                } elseif (in_array($ext, $audio)) {
                                    echo "<audio controls='controls' ><source src='$url_sianida/$soal[file]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                } else {
                            ...
                            if ($soal['file1'] <> '') {
                                ...
                                $ext = end($ext);
                                if (in_array($ext, $image)) {
                                    echo "<span  id='zoom1' style='display:inline-block'> <img  src='$url_sianida/$soal[file1]' class='img-responsive'/></span>";
                                } elseif (in_array($ext, $audio)) {
                                    echo "<audio controls='controls' ><source src='$url_sianida/$soal[file1]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                } else {
                                    echo "File tidak didukung!";
                                }
                            }
                                        ...
                                        <tr>
                                            ...
                                            <td style='vertical-align:middle;'>
                                                ...
                                                <?php if ($soal[$fileAA] <> '') : ?>
                                                    ...
                                                    $ext = end($ext);
                                                    if (in_array($ext, $image)) :
                                                        echo "<span  class='lup' style='display:inline-block'><img src='$url_jawaban/$soal[$fileAA]' class='img-responsive' style='width:250px;'/></span>";
                                                    elseif (in_array($ext, $audio)) :
                                                        echo "<audio controls='controls' ><source src='$url_jawaban/$soal[$fileAA]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                    else :
                                                        echo "File tidak didukung!";
                                                    endif;
                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style='vertical-align:middle;'>
                                                ...
                                                if ($soal[$fileBB] <> '') {
                                                    ...
                                                    $ext = end($ext);
                                                    if (in_array($ext, $image)) :
                                                        echo "<span  class='lup' style='display:inline-block'><img src='$url_jawaban/$soal[$fileBB]' class='img-responsive' style='width:250px;'/></span>";
                                                    elseif (in_array($ext, $audio)) :
                                                        echo "<audio controls='controls' ><source src='$url_jawaban/$soal[$fileBB]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                    else :
                                                        echo "File tidak didukung!";
                                                    endif;
                                                }
                                        ...
                                        <tr>
                                            ...
                                            <td style='vertical-align:middle;'>
                                                ...
                                                if ($soal[$fileCC] <> '') {
                                                    ...
                                                    $ext = end($ext);
                                                    if (in_array($ext, $image)) {
                                                        echo "<span  class='lup' style='display:inline-block'><img src='$url_jawaban/$soal[$fileCC]' class='img-responsive' style='width:250px;'/></span>";
                                                    } elseif (in_array($ext, $audio)) {
                                                        echo "<audio controls='controls' ><source src='$url_jawaban/$soal[$fileCC]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                    } else {
                                                        echo "File tidak didukung!";
                                                    }
                                                }
                                            ...
                                            <tr>
                                                ...
                                                <td style='vertical-align:middle;'>
                                                    ...
                                                    if ($soal[$fileDD] <> '') {
                                                        ...
                                                        $ext = end($ext);
                                                        if (in_array($ext, $image)) {
                                                            echo "<span  class='lup' style='display:inline-block'><img src='$url_jawaban/$soal[$fileDD]' class='img-responsive' style='width:250px;'/></span>";
                                                        } elseif (in_array($ext, $audio)) {
                                                            echo "<audio controls='controls' ><source src='$url_jawaban/$soal[$fileDD]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                        } else {
                                                            echo "File tidak didukung!";
                                                        }
                                                    }
                                            ...
                                            <tr>
                                                ...
                                                <td style='vertical-align:middle;'>
                                                    ...
                                                    if ($soal[$fileEE] <> '') {
                                                        ...
                                                        $ext = end($ext);
                                                        if (in_array($ext, $image)) {
                                                            echo "<span  class='lup' style='display:inline-block'><img src='$url_jawaban/$soal[$fileEE]' class='img-responsive' style='width:250px;'/></span>";
                                                        } elseif (in_array($ext, $audio)) {
                                                            echo "<audio controls='controls' ><source src='$url_jawaban/$soal[$fileEE]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                        } else {
                                                            echo "File tidak didukung!";
                                                        }
                                                    } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style='vertical-align:middle;'>
                                            ...
                                            if ($soal['fileA'] <> '') {
                                                ...
                                                $ext = end($ext);
                                                if (in_array($ext, $image)) {
                                                    echo "<img src='$url_jawaban/$soal[fileA]' class='img-responsive' style='max-width:300px;'/>";
                                                } elseif (in_array($ext, $audio)) {
                                                    echo "<audio controls='controls'><source src='$url_jawaban/$soal[fileA]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                } else {
                                                    echo "File tidak didukung!";
                                                }
                                            }
                                    ...
                                    <tr>
                                        ...
                                        <td style='vertical-align:middle;'>
                                            ...
                                            if ($soal['fileB'] <> '') {
                                                ...
                                                $ext = end($ext);
                                                if (in_array($ext, $image)) {
                                                    echo "<img src='$url_jawaban/$soal[fileB]' class='img-responsive' style='max-width:300px;'/>";
                                                } elseif (in_array($ext, $audio)) {
                                                    echo "<audio controls='controls' ><source src='$url_jawaban/$soal[fileB]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                } else {
                                                    echo "File tidak didukung!";
                                                }
                                            }
                                    ...
                                    <tr>
                                        ...
                                        <td style='vertical-align:middle;'>
                                            ...
                                            if ($soal['fileC'] <> '') {
                                                ...
                                                $ext = end($ext);
                                                if (in_array($ext, $image)) {
                                                    echo "<img src='$url_jawaban/$soal[fileC]' class='img-responsive' style='max-width:300px;'/>";
                                                } elseif (in_array($ext, $audio)) {
                                                    echo "<audio controls='controls' ><source src='$url_jawaban/$soal[fileC]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                } else {
                                                    echo "File tidak didukung!";
                                                }
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td style='vertical-align:middle;'>
                                                ...
                                                if ($soal['fileD'] <> '') {
                                                    ...
                                                    $ext = end($ext);
                                                    if (in_array($ext, $image)) {
                                                        echo "<img src='$url_jawaban/$soal[fileD]' class='img-responsive' style='max-width:300px;'/>";
                                                    } elseif (in_array($ext, $audio)) {
                                                        echo "<audio controls='controls' ><source src='$url_jawaban/$soal[fileD]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                    } else {
                                                        echo "File tidak didukung!";
                                                    }
                                                }
                                        ...
                                        <tr>
                                            ...
                                            <td style='vertical-align:middle;'>
                                                ...
                                                if ($soal['fileE'] <> '') {
                                                    ...
                                                    $ext = end($ext);
                                                    if (in_array($ext, $image)) {
                                                        echo "<img src='$url_jawaban/$soal[fileE]' class='img-responsive' style='max-width:300px;'/>";
                                                    } elseif (in_array($ext, $audio)) {
                                                        echo "<audio controls='controls' ><source src='$url_jawaban/$soal[fileE]' type='audio/$ext' style='width:100%;'/>Your browser does not support the audio tag.</audio>";
                                                    } else {
                                                        echo "File tidak didukung!";
                                                    }
                                                }
