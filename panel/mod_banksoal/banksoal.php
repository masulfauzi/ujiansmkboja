                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                    ...
                                                                    if ($soal['fileA'] <> '') {
                                                                        ...
                                                                        $ext = end($ext);
                                                                        if (in_array($ext, $image)) {
                                                                            echo "<img src='$url_jawaban/$soal[fileA]' style='max-width:100px;'/>";
                                                                        } elseif (in_array($ext, $audio)) {
                                                                            echo "<audio controls><source src='$url_jawaban/$soal[fileA]' type='audio/$ext'>Your browser does not support the audio tag.</audio>";
                                                                        } else {
                                                                            echo "File tidak didukung!";
                                                                        }
                                                                    }
                                                                ...
                                                                <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                    ...
                                                                    if ($soal['fileC'] <> '') {
                                                                        ...
                                                                        $ext = end($ext);
                                                                        if (in_array($ext, $image)) {
                                                                            echo "<img src='$url_jawaban/$soal[fileC]' style='max-width:100px;' />";
                                                                        } elseif (in_array($ext, $audio)) {
                                                                            echo "<audio controls><source src='$url_jawaban/$soal[fileC]' type='audio/$ext'>Your browser does not support the audio tag.</audio>";
                                                                        } else {
                                                                            echo "File tidak didukung!";
                                                                        }
                                                                    }
                                                                ...
                                                                <?php if ($namamapel['opsi'] == 5) : ?>
                                                                    ...
                                                                    <td style="padding: 3px; vertical-align: text-top;">
                                                                        ...
                                                                        if ($soal['fileE'] <> '') {
                                                                            ...
                                                                            $ext = end($ext);
                                                                            if (in_array($ext, $image)) {
                                                                                echo "<img src='$url_jawaban/$soal[fileE]' style='max-width:100px;' />";
                                                                            } elseif (in_array($ext, $audio)) {
                                                                                echo "<audio controls><source src='$url_jawaban/$soal[fileE]' type='audio/$ext'>Your browser does not support the audio tag.</audio>";
                                                                            } else {
                                                                                echo "File tidak didukung!";
                                                                            }
                                                                        }
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                    ...
                                                                    if ($soal['fileB'] <> '') {
                                                                        ...
                                                                        $ext = end($ext);
                                                                        if (in_array($ext, $image)) {
                                                                            echo "<img src='$url_jawaban/$soal[fileB]' style='max-width:100px;' />";
                                                                        } elseif (in_array($ext, $audio)) {
                                                                            echo "<audio controls><source src='$url_jawaban/$soal[fileB]' type='audio/$ext'>Your browser does not support the audio tag.</audio>";
                                                                        } else {
                                                                            echo "File tidak didukung!";
                                                                        }
                                                                    }
                                                                ...
                                                                <?php if ($namamapel['opsi'] <> 3) : ?>
                                                                    ...
                                                                    <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                        ...
                                                                        if ($soal['fileD'] <> '') {
                                                                            ...
                                                                            $ext = end($ext);
                                                                            if (in_array($ext, $image)) {
                                                                                echo "<img src='$url_jawaban/$soal[fileD]' style='max-width:100px;' />";
                                                                            } elseif (in_array($ext, $audio)) {
                                                                                echo "<audio controls><source src='$url_jawaban/$soal[fileD]' type='audio/$ext'>Your browser does not support the audio tag.</audio>";
                                                                            } else {
                                                                                echo "File tidak didukung!";
                                                                            }
                                                                        }
